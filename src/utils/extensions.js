const extensions = {
  ...
  Bitmoji: { id: 'bfgdeiadkckfbkeigkoncpdieiiefpig', file: 'popup.html' },
  ...
  BetterTTV: { id: 'ajopnjidmegmdimjlfnijceegpefgped', file: 'betterttv.js' },
  ...
  MEGA: { id: 'bigefpfhnfcobdlfbedofhhaibnlghod', file: 'mega/secure.html' },
  ...
  Scener: { id: 'lkhjgdkpibcepflmlgahofcmeagjmecc', file: 'ScenerIcon.png' },
  'Jitsi Meetings': {
  ...
  Volumix: { id: 'lkcmjdbopejhghppmbokkdocmdlefddm', file: 'content.css' },
  ...
  '7TV': { id: 'ammjkodgmmoknidbanneddgankgfejfh', file: 'twitch.js' },
  ...
  CatchOn: { id: 'njdniclgegijdcdliklgieicanpmcngj', file: 'env/dev.json' },
  wanteeed: {
  ...
  EPUBReader: { id: 'jhhclmfgfllimlhabjkgkeebkbiadflb', file: 'reader.html' },
  ...
  'think-cell': { id: 'ppcdkdcafnbklehdngbhmhpidandcjke', file: 'inject.js' },
  ...
  Smarty: { id: 'edjkecefjhobekadlkdkopkggdefpgfp', file: 'css/bootstrap.css' },
  'Seznam doplněk - Esko': {
  ...
  'Repeat button': { id: 'iicpikopjmmincpjkckdngpkmlcchold', file: 'dis.png' },
  ...
  WhatRuns: { id: 'cmkdbmfndkfgebldhnkbfhlneefdaaip', file: 'js/wrs_env.js' },
  'GIPHY for Chrome': {
  ...
  PreMiD: { id: 'agjnjboanicjcpenljmaaigopkgdnihi', file: 'js/devHelper.js' },
  ...
  Nami: { id: 'lpfcbjknijpeeillifnkikgncikgfhdo', file: 'icon-128.png' },
  ...
  CTabs: { id: 'ccljlmmlgpdlbpgafhnejagfjdlonnij', file: 'icon-128.png' },
  ...
  rikaikun: { id: 'jipdnfibhldikgcjhfnomkfpcebammhp', file: 'css/popup.css' },
  'Email Extractor': {
  ...
  划词翻译: { id: 'ikhdkkncnoglghljlkmcimlnlhkeamad', file: 'normalize.css' },
  AutoPagerize: {
  ...
  'XPath Helper': { id: 'hgimnogjllphhhkhlmebbmlgjoejdpjl', file: 'bar.css' },
  CSSViewer: {
  ...
  Kaikas: { id: 'jblndlipeogpafnldhgmapagcccfchpi', file: 'inpage.js' },
  'Lean Library': {
  ...
  健康提醒: { id: 'gefpceefdmmojbgmfmnkeanmpclobjgj', file: 'js/jquery.js' },
  小丰二维码: {
  ...
  Visualping: { id: 'pemhgklkefakciniebenbfclihhmmfcd', file: 'img/bolt.png' },
  ...
  Blur: { id: 'epanfjkfahimkgomnigadpkobaefekcd', file: 'panel.html' },
  ...
  TransOver: { id: 'aggiiclaiamajehmlfpkjmlbadmkledi', file: 'popup.js' },
  ...
  MySmartPrice: { id: 'bofbpdmkbmlancfihdncikcigpokmdda', file: 'icon.png' },
  'Bass Boost: HD Audio': {
  ...
  Timer: { id: 'hepmlgghomccjinhcnkkikjpgkjibglj', file: 'img/48.png' },
  'Netflix 1080p': {
  ...
  'MEW CX': { id: 'nlbmnnijcnlegkjjpcfjclmcfggfefdm', file: 'js/cxWeb3.js' },
  'Power Thesaurus': {
  ...
  LockPW: { id: 'kjcloihghgncbdkaafgkckbokjnehfmo', file: 'scripts/md5.js' },
  ...
  FUTBIN: { id: 'adicaaffkmhgnfheifkjhopmambgfihl', file: 'js/hook.js' },
  ...
  Gyazo: { id: 'ffdaeeijbbijklfcpahbghahojgfgebo', file: 'imgs/crop.svg' },
  'Prime Party': {
  ...
  Crystal: { id: 'nmaonghoefpmlfgaknnboiekjhfpmajh', file: 'sidebar.html' },
